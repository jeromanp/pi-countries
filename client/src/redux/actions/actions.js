...
import { GET_COUNTRIES, GET_COUNTRY, ORDER_COUNTRIES, SEARCH_NAME, FILTER_CONTINENTS, ORDER_ALPHABETICAL } from "./type_actions"
...
export function orderAlpha (orderAlpha){
    return{
